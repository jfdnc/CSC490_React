//credit to https://github.com/sakshityagi/my-ical-generator/blob/master/lib/my-ical-generator.js
        ...
        var cal = {
            ...
            methods: {
                ...
                generate: function() {
                    ...
                    if(cal.events[0].method) {
                        g += 'METHOD:' + cal.events[0].method.toUpperCase() + '\n'
                    }
