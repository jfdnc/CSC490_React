...
router.get('/twitter/callback',
        ...
        function(req, res) {
            ...
            if(req.user.email!=null){
                ...
                if(req.user.email.split('@')[1]=='updateMe.com'){
                    changeEmail=1
                } else{
                    changeEmail=0
                }
                ...
                User.findOne({email: req.user.email}).then(function(user){                    
                     myId = user._id                     
                res.redirect('/?email='+req.user.email+'&firstName='+req.user.firstName+'&lastName='+req.user.lastName+'&jwt='+token2+'&changeEmail='+changeEmail+'&id='+myId+'&facebookStuff=')
                });
...
//DELETE ME
router.get('/testme/:id', function(req, res, next){
